            ...
            <CustomCard padding="13px">
              <Grid container justifyContent="space-between" alignItems="center">
                ...
                <Grid item>
                  ...
                  >
                    <AddIcon sx={{ fontSize: 15 }} className={poppins.className} />
                    Add IP
                  </Button>
                </Grid>
              </Grid>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell className={poppins.className} >IP Number</TableCell>
                    <TableCell className={poppins.className} >Branch</TableCell>
                ...
                <TableBody>
                  {data?.results?.map((row, index) => (
                    <TableRow key={row.id}>
                      <TableCell className={poppins.className} >{index + 1}</TableCell>
                      <TableCell className={poppins.className} >{row.first_name} {row.last_name}</TableCell>
                      <TableCell className={poppins.className} >{row.email}</TableCell>
                      <TableCell>
