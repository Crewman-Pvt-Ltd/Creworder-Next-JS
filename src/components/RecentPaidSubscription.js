        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <HeaderCell>Subscription Date</HeaderCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {data?.map((companydata, index) => (
              <TableRow key={companydata.id}>
                ...
                <DataCell>{companydata.packages || 'N/A'}</DataCell> {/* Adjusted property */}
                <DataCell>{companydata.subscriptionDate || 'N/A'}</DataCell> {/* Adjusted property */}
              </TableRow>
            ))}
          </TableBody>
        </Table>
...
export default RecentPaidSubscription;
