          ...
          <TableBody>
            {data?.map((companydata, index) => (
              <TableRow key={companydata.id}>
                ...
                <DataCell>{companydata.total_users || 'N/A'}</DataCell>
                <DataCell>{companydata.employees || 'N/A'}</DataCell>
                <DataCell>{companydata.clients || 'N/A'}</DataCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
...
export default CompaniesWithMostUsers;
