...
<Box display="flex" justifyContent="center">
            ...
            className={poppins.className} mt={2}>
                ...
                <Box>
                  <Typography
                    ...
                    sx={{
                      color: "#4f4f4f",
                      fontWeight: "400",
                      fontSize: "13px", // Smaller font size for Page Links section
                    }}
                  >
                    Page Links
                  </Typography>
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        name="privacyPolicy"
                        sx={{ transform: "scale(0.8)" }} // Smaller checkbox
                      />
                    }
                    label={
                      <Typography
