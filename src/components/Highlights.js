...
const items = [
  ...
  },
  {
    ...
    description:
      'Stay up-to-date with the workflow, targets assigned, accomplished targets &, etc.',
  },
  {
    icon: <QueryStatsRoundedIcon />,
    title: 'Order Tracking',
    description:
      'End-to-end tracking of orders from dispatch to Delivered/RTO',
  },
];
